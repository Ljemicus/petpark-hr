            ...
            <Sheet>
              ...
              <SheetContent side="left" className="w-[320px] overflow-y-auto">
                ...
                <div className="space-y-5">
                  <div>
                    <p className="mb-3 text-xs font-black uppercase text-[color:var(--pp-muted)]">{copy.type}</p>
                  ...
                  <div>
                    <label htmlFor="training-mobile-city-filter" className="mb-3 block text-xs font-black uppercase text-[color:var(--pp-muted)]">{copy.city}</label>
